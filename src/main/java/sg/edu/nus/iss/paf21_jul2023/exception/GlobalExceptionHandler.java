...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleResourceNotFoundExceiption
    ...
    public ResponseEntity<ErrorMessage> handleException(Exception ex, WebRequest request) {
         ...
         ErrorMessage errMsg = new ErrorMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(), new Date(),
